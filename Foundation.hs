...
instance Yesod App where
    ...
    defaultLayout widget = do
        ...
        let menuItems =
                ...
                , NavbarLeft $ MenuItem
                    { menuItemLabel = "Things"
                    , menuItemRoute = ThingsR
                    , menuItemAccessCallback = True
                    }
                , NavbarLeft $ MenuItem
        ...
        pc <- widgetToPageContent $ do
            ...
            addStylesheet $ StaticR css_pure_css
    ...
    isAuthorized ThingsR _ = return Authorized
    isAuthorized (ThingR _) _ = return Authorized
